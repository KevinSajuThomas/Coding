#The person is booking the railway ticket based on their age and the number of tickets they want to purchase.
#The prices are regular price : rs.50, senior citizen (Age 60 and above) price : rs.30 and for the children 
